...
export const gifts: GiftItem[] = [
  ...
  { id: "panelas-turim", name: "Panelas Alumínio Turim Tramontina 5 Peças", description: "Versatilidade para começar.", amount: 259, image: img("panelas-turim") },
  { id: "manta", name: "Manta Decorativa", description: "Aconchego na sala do casal.", amount: 250, image: img("manta") },
  { id: "talheres-inox", name: "Jogo de Talheres Inox", description: "Funcional e atemporal.", amount: 250, image: img("talheres-inox") },
